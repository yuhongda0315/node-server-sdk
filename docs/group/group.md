...
| memberIds	  		| array 	| 	是 	| 群成员 Id 列表 | 3.0.0 |
...
| :----------------	|:--------	|:-----	|:------------------------------|:----- |
| id		  		| string 	| 	是 	| 群组 Id，最大长度 30 个字符，建议使用 `英文字母`、`数字` 混排	 | 3.0.0 |
| memberIds	  		| array 	| 	是 	| 邀请入群的成员 Id 列表 | 3.0.0 |
...
| :----------------	|:--------	|:-----	|:------------------------------|:----- |
| id		  		| string 	| 	是 	| 群组 Id，最大长度 30 个字符，建议使用 `英文字母`、`数字` 混排	 | 3.0.0 |
| memberId	  		| string 	| 	是 	| 加群成员 Id | 3.0.0 |
...
| :----------------	|:--------	|:-----	|:------------------------------|:----- |
| id		  		| string 	| 	是 	| 群组 Id，最大长度 30 个字符，建议使用 `英文字母`、`数字` 混排	 | 3.0.0 |
| memberId	  		| string 	| 	是 	| 退出群成员 Id | 3.0.0 |
...
| :----------------	|:--------	|:-----	|:------------------------------|:----- |
| id		  		| string 	| 	是 	| 群组 Id，最大长度 30 个字符，建议使用 `英文字母`、`数字` 混排	 | 3.0.0 |
| memberIds	  		| array 	| 	是 	| 被移除群成员 Id 列表 | 3.0.0 |
...
| :----------------	|:--------	|:-----	|:------------------------------|:----- |
| id		  		| string 	| 	是 	| 群组 Id，最大长度 30 个字符，建议使用 `英文字母`、`数字` 混排	 | 3.0.0 |
| operator	  		| string 	| 	是 	| 解散群组操作者 | 3.0.0 |
